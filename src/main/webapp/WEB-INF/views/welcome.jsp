...
<body>
    ...
    <div class="container">
      ...
      <div class="blueBannerHeading">
        <h1 class="blueBannerTitleWithSubtitle">
          <a style="color: #ffffff">Oracle Container Cloud Service + Wercker - Lucas Demo</a>
        </h1>
      </div>
  ...
  <div class="container serviceContainer" style="margin-top: 150px;">
    <div class="overviewLayout">
      <div>
              <br>SpringBoot application demo by Lucas Gomes (OCCS deployment using webhooks). Current server time: <%= new java.util.Date() %> <br>
              <br>
              <p>
